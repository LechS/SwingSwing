...
class FbQueue
{
    ...
    /**
     * Set publicatedPostId
     *
     * @param string $publicatedPostId
     *
     * @return FbQueue
     */
    public function setPublicatedPostId($publicatedPostId)
    {
        $this->publicatedPostId = $publicatedPostId;

        return $this;
    }

    /**
     * Get publicatedPostId
     *
     * @return string
     */
    public function getPublicatedPostId()
    {
        return $this->publicatedPostId;
    }
